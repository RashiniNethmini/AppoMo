...
import bstyles from './BranchSignin.module.css';
...
export const BranchSignin = (props) => {
   ...
   const handleSubmit = async (e) => {
    ...
    fetch("http://localhost:8070/branchdetails/login", {
      method: 'POST',
      headers: {
        ...
        <Paper elevation={6} className={bstyles.signpapDiv}>
            ...
            <div>
                <div className={bstyles.signDiv}>
                    <div className={bstyles.signBodyText}>
                    ...
                    <div className={bstyles.signButton}>
                        <Button variant="contained" sx={{mr:'10px'}}  onClick={handleSubmit}>Sign in</Button>
                    </div>
                    <div className={bstyles.signFPw}>
                        <Link href="#" color="inherit">Forgot Password?</Link>
                    </div> 

                    {/* <div className={bstyles.signOR}>
                        <p>OR</p>
                    </div>  

                    <div className={bstyles.signNot}>
                        <p>Not Registered? &nbsp;</p>
                        <Link href="#">Register Now</Link>
                        
                     </div> 
                 <div className={bstyles.GButton} onClick={handleGoogleLoginSuccess} id="signInDiv"></div>   */}
